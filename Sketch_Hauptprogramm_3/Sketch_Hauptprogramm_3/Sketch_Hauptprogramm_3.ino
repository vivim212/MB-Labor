...
while(zaehler == 2){//Mess-Schleife, wird verlassen bei betätigen des Tasters
  ...
  weight = scale.get_units(1);//Hier kann auch Mittelwert aus mehreren Werten gebildet werden, aber nach möglichkeit lange Funktionen vermeiden,um ein verpassen des Taster-Drucks zu verhindern 
  F = weight * 9.81;
  lcd.setCursor(7, 0);
